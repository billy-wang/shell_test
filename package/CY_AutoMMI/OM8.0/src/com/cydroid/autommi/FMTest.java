...
import com.cydroid.autommi.utils.SysPropUtil;
 ...
 //   private RemoteServiceConnection mConnection;
                ...
                try {
                    ...
                    if (mBLUService.isDeviceOpen()) {
                        ...
                        try {
                            ...
                            DswLog.e(TAG, "mBLUService.tune:Exception=" + e.getMessage());
                        }
                    ...
                    DswLog.e(TAG, "mBLUService:Exception=" + e.getMessage());
    ...
    public void onPause() {
        ...
        try {
            ...
            e.printStackTrace();
            DswLog.i(TAG,"message="+e.getMessage());
        }
