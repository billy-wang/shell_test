...
public class IrControl {
    ...
    public IrControl(Context ctx) {
        ...
        if (objir == null)
            DswLog.d("RemoteIr", "No RemoteIR");
        if (method_transmit == null)
            DswLog.d("RemoteIr", "No Transmit Method");
        if (method_stop == null)
            DswLog.d("RemoteIr", "No Stop Method");
        if (method_receive == null)
            DswLog.d("RemoteIr", "No received Method");
        if (method_receive_init == null)
            DswLog.d("RemoteIr", "No receive_init Method");
        if (method_receive_is_ready == null)
            DswLog.d("RemoteIr", "receive_is_ready");
