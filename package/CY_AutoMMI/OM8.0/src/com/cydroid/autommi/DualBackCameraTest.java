...
public class DualBackCameraTest extends BaseActivity {
    ...
    private static final String START_CAMERA_ACTIVITY_BROADCAST = "com.cydroid.autommi.dualbcamera.start";
    private static final String END_CAMERA_ACTIVITY_BROADCAST = "com.cydroid.autommi.dualbcamera.end";
    private static final String GET_CAPTURE_RESULT_DATA_BROADCAST = "com.cydroid.autommi.dualbcamera.result";
	...
	*/
    BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (GET_CAPTURE_RESULT_DATA_BROADCAST.equals(intent.getAction())) {
                ...
                DswLog.i(TAG, "data.length="+data.length);
                if (data != null && data.length == 16) {
                    for (int i = 0; i < data.length; i++) {
                        DswLog.i(TAG, "data[" + i + "]=" + data[i]);
                    }
                    testResult(data);
                }
    ...
    private void testResult(int[] data){
        ...
        DswLog.i(TAG, "testResult:content="+content);
    ...
    private void writeProductInfoData(boolean isTestSuccess){
        ...
        DswLog.i(TAG, "sn_buff[28]="+sn_buff[28]);
    }
