...
import com.cydroid.autommi.EmSensor.EmSensor;
...
public class SensorsCalTest extends BaseActivity implements SensorEventListener {
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            case MSG_SHOW_RESULT:
                ...
                DswLog.i(TAG, "MSG_SHOW_RESULT:content="+content);
    ...
    private void doPSensorCalibration() {
        ...
        DswLog.i(TAG, "doPSensorCalibration result=" + mIsPSensorSuccess);
    }
    ...
    private void doGSensorCalibration() {
        ...
        DswLog.i(TAG, "doGSensorCalibration result=" + mIsGSensorSuccess);
    }
    ...
    private void doGyroscopeCalibration() {
        ...
        DswLog.i(TAG, "doGyroscopeCalibration result=" + mIsGyroscopeSuccess);
    }
    ...
    public void onSensorChanged(SensorEvent event) {
	    ...
	    DswLog.i(TAG, "mIsMSensorSuccess="+mIsMSensorSuccess+";mIsPSensorSuccess="+mIsPSensorSuccess+";mIsGSensorSuccess="+mIsGSensorSuccess
