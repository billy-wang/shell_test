...
/*Gionee huangjianqiang 20160322 add for CR01655509 begin*/
...
import com.cydroid.autommi.TouchPadTest.TouchPadView;

import com.cydroid.autommi.SimCardTest;
import com.cydroid.autommi.SdCardTest;

import com.cydroid.autommi.TouchPadTest;
...
public class SdSimTpTest extends BaseActivity {
    ...
    //Gionee zhangke 20151211 add for CR01606663 start
    private static final String TAG = "SdSimTpTest";
    //Gionee zhangke 20151211 add for CR01606663 end
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for(int i = 0; i < volumes.length; i++){
			...
			//Gionee zhangke 20151211 add for CR01606663 start
			DswLog.i(TAG, "path="+path+";state="+state);
			//Gionee zhangke 20151211 add for CR01606663 end

            //Gionee zhangke 20151211 modify for CR01606663 start
            //Gionee zhangke modify for CR01606671 start
			//if((path.contains("sdcard"))||(path.contains("emulated"))) {
            if(path.contains("storage")){
            //Gionee zhangke modify for CR01606671 end
            ...
            //Gionee zhangke 20151211 modify for CR01606663 end
		}
        //Gionee zhangke 20151211 add for CR01606663 start
        DswLog.i(TAG, "info="+info+";info.length()="+info.length());
        //Gionee zhangke 20151211 add for CR01606663 end
		...
		/*Gionee huangjianqiang 20160322 modify for CR01655509 begin*/
		TelephonyManager telephonyManager =
				(TelephonyManager)getSystemService(Context.TELEPHONY_SERVICE);
		int sim1State = telephonyManager.getSimState(0);
		int sim2State = telephonyManager.getSimState(1);
		String simInfo = "sim1:" + sim1State + "|sim2:" + sim2State;
		/*Gionee huangjianqiang 20160322 modify for CR01655509 end*/
		((AutoMMI)getApplication()).recordResult(SimCardTest.TAG, simInfo, "2");
		Toast.makeText(this, simInfo, Toast.LENGTH_LONG).show();
		/* SIM_STATE_ABSENT          1
	...
	public class TouchPadView extends View {
		...
		protected void onDraw(Canvas canvas) {
			...
			/*
			 * DswLog.d(TAG, "*********mTestRecs.size() = " + mTestRecs.size()); if
		...
		public boolean onTouchEvent(MotionEvent event) {
			...
			if (x < mAverageWidth) {
				...
				if (-1 != i && false == mLeftList.contains(i)) {
					mLeftList.add(i);
					DswLog.e("lich", "mLeftList.add(i) = " + i);
				}
