    ...
    public void onResume() {
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
				 ...
				 */
                switch (mPname) {
                    //Gionee <GN_BSP_MMI> <chengq> <20170217> modify for ID 69250 begin
                    case SWW1618:
                    case SWW1617:
                        if (cm.hasIrEmitter()) {
                            Log.i("ConsumerIr",
                            ...
                            Log.i("ConsumerIr","Ir is not ok, break");
                        }

                        break;
                    //Gionee <GN_BSP_MMI> <chengq> <20170217> modify for ID 69250 end
                    case SWW1609:
                        if (cm.hasIrEmitter()) {
                            try {
...
//                }
    ...
    public void test_transmit() {
        ...
        try {
            Log.d("ConsumerIr", "send google Ir data");
            for (int i = 0; i < 25; i++) {
