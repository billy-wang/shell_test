...
public class SensorsCalTest extends BaseActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG," record in onCreate begin");
        ((AutoMMI) getApplication()).recordResult(TAG, "", "0");
        Log.d(TAG," record in onCreate end");
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            case MSG_SHOW_RESULT:
                ...
                Log.d(TAG," record in showResult begin");
                ...
                Log.d(TAG," record in showResult end");
                break;
            }
        }
    };
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        Log.d(TAG," onSensorChanged sendEmptyMessage to record");
        if (3 == event.accuracy) {
