...
public class LaserTest extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "mCmdId="+mCmdId + ";mSpec="+mSpec);
    ...
    private void execCmd(int  cmd){
        if(cmd == LASER_PCB_ID){
            ...
            Log.i(TAG, "mTestValue = "+ mTestValue);
            ...
            Log.i(TAG, "laserOffsetCalStart = "+laserOffsetCalStart+";laserOffsetCalDo="+laserOffsetCalDo+";mTestValue="+mTestValue);
            mUiHandler.sendEmptyMessage(EVENT_RESPONSE_CMD);
            ...
            Log.i(TAG, "laserCrosstalkCalStart = "+laserCrosstalkCalStart+";laserCrosstalkCalDo="+laserCrosstalkCalDo+";mTestValue="+mTestValue);
            mUiHandler.sendEmptyMessage(EVENT_RESPONSE_CMD);
			...
			Log.i(TAG, "mLaserOffsetCalDo = "+mLaserOffsetCalDo+";mLaserCrosstalkCalDo="+mLaserCrosstalkCalDo);
    ...
    private void showResult(){ 
        ...
        Log.i(TAG, "mCmdId="+mCmdId+";mTestValueString="+mTestValueString+";mIsTestSuccess="+mIsTestSuccess);
        if(mCmdId == LASER_DISTANCE_100_ID || mCmdId == LASER_DISTANCE_400_ID){
            ...
            Log.i(TAG, "testDistance100="+testDistance100+";testDistance400="+testDistance400+";snNumber="+new String(sn_buff));
        }
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        if (mTimes < mMaxTimes) {
                            ...
                            Log.i(TAG, "mTestValueArray[" + mTimes + "]=" + mTestValueArray[mTimes] + ";mIsTestSuccess="
                                + mIsTestSuccess);
                            if (++mTimes >= mMaxTimes) {
                                if (mIsTestSuccess) {
