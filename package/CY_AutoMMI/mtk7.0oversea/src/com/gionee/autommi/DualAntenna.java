...
public class DualAntenna extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "majorPhoneId="+majorPhoneId);
    ...
    private void execCmd(String  cmd){
        try {
            ...
            Log.e(TAG,"send fail:"+ee.getMessage());
        }
                ...
                case EVENT_RESPONSE_CMD: {
                    if (ar.exception == null) {
                        try {
                            ...
                            if(txt.contains("OK")){
                                Log.i(TAG, "The resopnse contains OK ");
                                mTestResult = "ok";
                                ...
                                if(txt.contains("ETXANT")){
                                    ...
                                    try {
                                        ...
                                        mRat_id = -1;
                                        mAnt_idx = -1;
                                        Log.e(TAG,"string to int error:"+e.getMessage());
                                    }
                                    
                                }else if(txt.contains("ERROR")){
                                    mTestResult = txt.substring(txt.indexOf("<") + 1, txt.indexOf(">"));
                                    Log.i(TAG, "The resopnse contains ERROR "+ mTestResult);
                                }
                            }
                            ...
                            Log.e(TAG,"UnsupportedEncodingException="+ee.getMessage());
                        }


                    } else {
                        Log.e(TAG, "EVENT_RESPONSE_TO_MAINANTENNA fail:" + ar.exception);
    ...
    private void showResult(){ 
		...
		Log.i(TAG, "showResult:mResultTitle="+mResultTitle+";mRat_id="+mRat_id
