...
public class NFCTest extends BaseActivity {  
	...
	if(!mNfcAdapter.isEnabled()){
		DswLog.i("aaaa","Adapter != isEnable");
		mNfcAdapter.enable();
		}
	...
	protected void onStop() {
		...
		super.onStop();
    	DswLog.i("aaaa","onStop");
		mNfcAdapter.disable();
		this.finish();
	}

    public void onNewIntent(Intent intent) {
        DswLog.i("aaaa","intent.getAction()="+intent.getAction());
