...
public final class FeatureOption{
	...
	public static boolean GN_RW_GN_MMI_KEYTEST_EAR_SUPPORT;
    //keys end
    ...
    public static boolean GN_RW_GN_MMI_GPS_COCLOCK_SUPPORT;
	...
	private static final String GN_RW_GN_MMI_KEYTEST_EAR = "GN_RW_GN_MMI_KEYTEST_EAR";
    private static final String GN_RW_GN_MMI_GSMC2 = "GN_RW_GN_MMI_GSMC2";
    private static final String GN_RW_GN_MMI_GPS_COCLOCK = "GN_RW_GN_MMI_GPS_COCLOCK";
    ...
    public static void initMmiXml() {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                ...
                }else if(GN_RW_GN_MMI_KEYTEST_EAR.equals(name)){
					GN_RW_GN_MMI_KEYTEST_EAR_SUPPORT= Boolean.parseBoolean(value);
				} else if (GN_RW_GN_MMI_GSMC2.equals(name)) {
                    GN_RW_GN_MMI_GSMC2_SUPPORT = Boolean.parseBoolean(value);
                } else if (GN_RW_GN_MMI_GPS_COCLOCK.equals(name)) {
                    GN_RW_GN_MMI_GPS_COCLOCK_SUPPORT = Boolean.parseBoolean(value);
