...
public class NvService extends Service {
    ...
    private void sendIntentLocked() {
        ...
        //Gionee <GN_BSP_MMI> <lifeilong> <20170328> modify for ID 95062 begin
        final Intent intent = new Intent(Intent.ACTION_MASTER_CLEAR);
        intent.addFlags(Intent.FLAG_RECEIVER_FOREGROUND);
        intent.putExtra(Intent.EXTRA_REASON, "MasterClearConfirm");
        //Gionee <GN_BSP_MMI> <lifeilong> <20170407> modify for ID 106342 begin
        //intent.putExtra("keep3rd", "keep3rd");
        intent.putExtra("eraseInternalData", true);
        //Gionee <GN_BSP_MMI> <lifeilong> <20170407> modify for ID 106342 end
        Log.e(TAG, "ACTION_MASTER_CLEAR,FLAG_RECEIVER_FOREGROUND,Intent.EXTRA_REASON MasterClearConfirm  keep3rd + keep3rd");
        sendBroadcast(intent);
        //Gionee <GN_BSP_MMI> <lifeilong> <20170328> modify for ID 95062 end
    }
