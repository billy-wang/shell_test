...
public class FrontCameraTest2 extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "FrontCameraTest2 oncreate");
        ...
        Log.e(TAG,"FrontCameraTest sendintent gn.com.android.mmitest.item.FrontCameraTest2");
        ...
        Log.e(TAG, "FrontCameraTest2  startActivityForResult");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.e(TAG, "FrontCameraTest2 onResume ");
    ...
    public void onPause() {
        super.onPause();
        Log.e(TAG, "FrontCameraTest2 onPause ");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.e(TAG, "FrontCameraTest2 onActivityResult" + "requestCode = " + requestCode + " resultCode = " + resultCode);
        if(data == null){
