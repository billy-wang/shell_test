...
public class A3Activity extends Activity implements OnClickListener {
    ...
    private static final String TAG = "A3Activity";///system/etc/
    private static final String  RESULT_PATH = "/system/etc/";//"/data/app/";///data/misc/gionee/veba3/
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        TestUtils.setWindowFlags(this);
        setContentView(R.layout.a3_test);
        Log.d(TAG,"oncreate A3Activity" );
        ...
        public void handleMessage(Message msg) {
            ...
            case UPDATE_TEST:
                ...
                if (ret3 == ZytJniInterface.UPDATE_COS_COMPUTING) {
                    ...
                    String version = ZytJniInterface.getChipVersion(A3Activity.this);
                    if (version != null) {
                        String versionString = new String(version);
                        appendText("\u5347\u7ea7\u6d4b\u8bd5\u540e\u7684version:" + versionString);
                    } else {
                        appendText(
                                "\u5347\u7ea7\u6d4b\u8bd5\u540e\u7684version:\u5347\u7ea7\u6210\u529f\uff0c\u4f46\u662f\u82af\u7247\u7248\u672c\u53f7\u83b7\u53d6\u5f02\u5e38\uff0c\u8bf7\u518d\u6b21\u5c1d\u8bd5");
                    }
            ...
            if (clickFlag == true) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        int ret3 = ZytJniInterface.updateAndTestDriver(A3Activity.this, cosfile);
