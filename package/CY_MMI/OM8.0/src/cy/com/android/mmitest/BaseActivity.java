...
public class BaseActivity extends Activity {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        DswLog.e("BaseActivity", "onConfigurationChanged update");
    }

    private void ConfigLanguage() {
        if (CyMMITestApplication.languageState  == -1) {
            return;
        }
        ...
        DswLog.d(TAG, "update config.locale:" + config.locale);
    ...
    protected void setWindowFlags() {
        ...
        //Chenyee <CY_BSP_MMI> <chengq> <20170830> modify for CR 199791 begin
        window.setNavigationBarColor(Color.parseColor("#ff000000"));
        //Chenyee <CY_BSP_MMI> <chengq> <20170830> modify for CR 199791 end
