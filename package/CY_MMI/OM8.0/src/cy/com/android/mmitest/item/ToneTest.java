...
public class ToneTest extends BaseActivity implements OnClickListener {
    Button mToneBt;
    ...
    private static final String TAG = "ToneTest_billy";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        DswLog.d(TAG, "\n\n\n****************打开扬声器 @" + Integer.toHexString(hashCode()));
    ...
    protected void onDestroy() {
        super.onDestroy();
        DswLog.d(TAG, "\n****************退出扬声器 @" + Integer.toHexString(hashCode()));
    }
    ...
    public void onResume() {
        ...
        new Thread() {
            public void run() {
                ...
                DswLog.e(TAG, " set setParameters :MMITone=1");
    ...
    public void onPause() {
        ...
        try{
            ...
            DswLog.i(TAG, "ToneTest onPause audio is broken");
            e.printStackTrace();
        }
