...
import cy.com.android.mmitest.item.lockpatternview.LockPatternView;
import cy.com.android.mmitest.item.lockpatternview.LockPatternUtils;
import cy.com.android.mmitest.item.lockpatternview.LockPatternView.Cell;
import cy.com.android.mmitest.item.lockpatternview.LockPatternView.DisplayMode;
import cy.com.android.mmitest.item.lockpatternview.LockPatternView.OnPatternListener;
...
public class ForceTouchTest extends BaseActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        DswLog.e(TAG, "mIsAutoMode:" + mIsAutoMode);
        if (mIsAutoMode) {
            ...
            DswLog.e(TAG, "startActivityForResult:");
    ...
    private boolean is3DTouchPass() {
        ...
        if (productInfoBuff != null && productInfoBuff.length > 32) {
            DswLog.i(TAG, "isFactoryResetBoot:productInfoBuff[32]=" + productInfoBuff[32]);
