...
public class SingleTestGridView extends BaseActivity implements GridView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        // TODO Auto-generated method stub
        try {
            mIt.setClass(this, Class.forName("cy.com.android.mmitest.item." + mItemKeys[position]));
            DswLog.e(TAG, "in hardware mmi test you choose item is =  " + mItemKeys[position]);
            startActivity(mIt);
