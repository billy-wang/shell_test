...
//Gionee <GN_BSP_MMI> <chengq> <20170315> modify for ID 80014 begin
    ...
    protected void onStart() {
        super.onStart();
        Log.e(TAG, "iscalibration onStart ");
    ...
    protected void onStop() {
        super.onStop();
        Log.e(TAG, "iscalibration onStop ");
        if (!mIsRomVersion && null != mSensorMgr)
...
//    }
    ...
    protected void onDestroy() {
        Log.e(TAG, "iscalibration  onDestroy");
    ...
    private BroadcastReceiver mBroadcastReceiver =new BroadcastReceiver (){
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals("com.gionee.magneticfield.MMITEST")) {
                ...
                Log.e(TAG, "mBroadcastReceiver intent.getAction()+ calibration ="+calibration);
