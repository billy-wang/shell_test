...
public class GnMMITest extends BaseActivity implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Gionee <Oveasea_Bug> <tanbotao> <20161217> for 42280 beign
        Settings.System.putInt(getContentResolver(),Settings.System.SOUND_EFFECTS_ENABLED,0);
        //Gionee <Oveasea_Bug> <tanbotao> <20161217> for 42280 end
		...
		Log.d(TAG,"start and save GnMMITestApplication.rotation is "+ GnMMITestApplication.rotation);
    ...
    private void releaseMmi(boolean exit) {
		...
		Log.d(TAG,"exit and set GnMMITestApplication.rotation is "+ GnMMITestApplication.rotation);
		//Gionee <GN_BSP_MMI> <chengq> <20170224> add for ID 49681 end
        //Gionee <GN_BSP_MMI> <chengq> <20170216> modify for ID 70046 end
