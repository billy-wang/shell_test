        ...
        new Thread() {
            public void run() {
                ...
                if (null != mAM) {
                    ...
                    Log.e(TAG, " set mode  = mode STREAM_VOICE_CALL , MODE_IN_CALL ");
                    Log.e(TAG, " set stream  = STREAM_VOICE_CALL ");
                    //Log.e(TAG, " set setParameters :MMIReceiver=1 ");
                    ...
                    mAM.setStreamVolume(AudioManager.STREAM_VOICE_CALL, (maxVol - 3), 0);
                    int max = mAM.getStreamMaxVolume(AudioManager.STREAM_VOICE_CALL );
                    Log.e(TAG, "maxVol = " + maxVol + " setStreamVolume = " + (maxVol - 3));
