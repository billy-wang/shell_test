...
public class GnMMITestApplication extends Application {
    ...
    private static GnMMITestApplication mApplication;
    ...
    private class MyHandler extends Handler { //Handler
        ...
        public void handleMessage(Message msg) {
            Log.e(TAG, "handleMessage msg.what:" + msg.what + " msg.arg1:" + msg.arg1);
    ...
    public static GnMMITestApplication getApplication() {
        return  mApplication;
    }
