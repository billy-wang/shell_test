...
public class FMTest extends Activity implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    private class RemoteServiceConnection implements ServiceConnection {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            try {
                ...
                e.printStackTrace();
                Log.e(TAG, "IFMRadioService RemoteException:"+e.getMessage());
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Gionee <GN_BSP_MMI> <lifeilong> <20170406> modify for ID 98079 end
    ...
    private class EarphonePluginReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(Intent.ACTION_HEADSET_PLUG)) {
                ...
                if (0 == state) {
                    if (true == mIsBind) {
                        //Gionee <GN_SBP_MMI> <lifeilong> <20170327> modify for ID 95270 begin
                        if(null != mService){
                            unbindService(mConnection);
                        }
                        //Gionee <GN_SBP_MMI> <lifeilong> <20170327> modify for ID 95270 end
                        mIsBind = false;
                    }
                    ...
                    uiHandler.sendEmptyMessageDelayed(0,100);
                    if (false == mIsBind) {
                        intent = new Intent("com.caf.fmradio.IFMRadioService");
