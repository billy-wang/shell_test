...
import gn.com.android.emsvr.AFMFunctionCallEx;
import gn.com.android.emsvr.FunctionReturn;
...
public class Cpufreq extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mBtnStartTest == null || mBtnStopTest == null || mBtnCurrentTest == null || mInfo == null) {
        ...
        if (arg0.getId() == mBtnStartTest.getId()) {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    for (int i = 0; i < 23 && mRun; i++) // step by step --> 520
                                                         // ~ 806// MHZ
                    {
                        mInfoStr = "Info: \n";
                        ...
                        try {
                            sleep(500);// sleep too short cause TextView display
                                       // error.
            ...
            AFMFunctionCallEx A = new AFMFunctionCallEx();
            boolean result = A.StartCallFunctionStringReturn(AFMFunctionCallEx.FUNCTION_EM_CPU_FREQ_TEST_STOP);
            A.WriteParamNo(0);
