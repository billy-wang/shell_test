    ...
    Thread.UncaughtExceptionHandler mUncaughtHandler = new UncaughtExceptionHandler() {
        ...
        public void uncaughtException(Thread thread, Throwable ex) {
            ...
            try{
                ...
                TestUtils.writeNodeState(GnMMITestApplication.this,GnMMITest.NODE_TYPE_POWER_SUPPLY_BATTERY_MMI_STATUS,0);
                Log.e(TAG,"GnMMITestApplication  GnMMITestApplication -- > NODE_TYPE_POWER_SUPPLY_BATTERY_MMI_STATUS -- > 0 ");
                //Gionee <GN_BSP_MMI> <lifeilong> <20170427> modidy for ID 126356 end
                gnMethod.getInvokeResult1(GnMMITestApplication.this);

                StatusBarManager mStatusBarManager = (StatusBarManager) GnMMITestApplication.this.getSystemService("statusbar");
