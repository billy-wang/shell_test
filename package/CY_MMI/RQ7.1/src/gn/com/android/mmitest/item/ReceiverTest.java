...
public class ReceiverTest extends Activity implements OnClickListener {
    ...
    public void onResume() {
        ...
        if (null != mAM) {
            //Gionee <GN_BSP_MMI> <lifeilong> <20170919> modify for ID 217564 begin
            ...
            //Gionee <GN_BSP_MMI> <lifeilong> <20170919> modify for ID 217564 end
            String aString = TestUtils.setStreamVoice("ReceiverTest");
            int i = 1;//Integer.valueOf(aString).intValue();
