    ...
    protected void onStart() {
        ...
        if (false == mWifiMgr.isWifiEnabled()) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        Log.e(TAG," BEGIN_TO_SCAN ");
                        //Gionee <GN_BSP_MMI><lifeilong><20170525> add for ID 148233 begin
                        timer.schedule(myTimerTask,3000,4000);
                        //Gionee <GN_BSP_MMI><lifeilong><20170525> add for ID 148233 end
            ...
            try {
                ...
                Log.e(TAG,"= = Exception = = onStart catch " );
                e.printStackTrace();
                new Timer().schedule(myTimerTask,3000,4000);
            }
