...
public class TestResult extends Activity implements QcRilHookCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mQuickBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TestUtils.mIsForSale){
                    if(TestUtils.mIsAutoMode ||TestUtils.mIsAutoMode_2){
    ...
    public void onQcRilHookReady() {
        ...
        if (factoryResult.length() == 32 || factoryResult.length() == 64) {
            ...
            //Gionee <GN_BSP_MMI> <lifeilong> <20170615> modify for ID 157932 begin
            Log.e(TAG, "barcodes[32] = " + barcodes[MMI_WCHAT_SOTER_TAG]);
            Log.e(TAG, "barcodes[33] = " + barcodes[MMI_IFAA_KEY_TAG]);
            //Gionee <GN_BSP_MMI> <lifeilong> <20170615> modify for ID 157932 end
