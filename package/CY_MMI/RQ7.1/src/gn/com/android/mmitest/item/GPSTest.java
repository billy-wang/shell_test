...
public class GPSTest extends Activity implements LocationListener, Listener, OnClickListener {
        ...
        public void run() {
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    Log.d(TAG,"TimerCountTask  = " + taskCount );
                }
            });
            mTimeCount++;
        }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (null != location) {
            ...
            Log.d(TAG,"" + mRs.getString(R.string.longitude) + location.getLongitude() + "  , "
                    + mRs.getString(R.string.latitude) + location.getLatitude() + " ,  "
                    + mRs.getString(R.string.altitude) + location.getAltitude());
    ...
    public void onClick(View v) {
        ...
        case R.id.right_btn: {
            ...
            Log.d(TAG,"pressbotton is right_btn" );
        ...
        case R.id.wrong_btn: {
            ...
            Log.d(TAG,"pressbotton is wrong_btn" );
        ...
        case R.id.restart_btn: {
            ...
            Log.d(TAG,"pressbotton is restart_btn" );
