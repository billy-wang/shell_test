...
public class FingerPrintsTest3 extends BaseActivity implements OnClickListener  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        DswLog.d(TAG, "\n\n\n****************打开指纹性能检测 @" + Integer.toHexString(hashCode()));
    ...
    protected void onDestroy() {
        super.onDestroy();
        DswLog.d(TAG, "\n****************退出软性能检测 @" + Integer.toHexString(hashCode()));
    }
    ...
    public void onResume() {
        super.onResume();
        DswLog.i(TAG, "onResume mFingerprintSensorTest selfTest :mFingerprintSensorTest="+mFingerprintSensorTest);
        try{
            DswLog.i(TAG, "onResume begin captureImage");
            mFingerprintSensorTest.fingertest(true,mFingerprintSensorTestListener);
            DswLog.i(TAG, "onResume end captureImage");
        }catch(Exception e){
            titleTv.setText(R.string.fingerprints_load_fail);
            DswLog.e(TAG, "captureImage Exception="+e.getMessage());
        }
    }
