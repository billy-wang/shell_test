...
public class BluetoothTest extends BaseActivity implements View.OnClickListener {
    ...
    private static final int BlUE_UPDATE_UI = 3;

    private List<BluetoothDevice> mDevices = new ArrayList<BluetoothDevice>();

    //Gionee <GN_BSP_MMI> <chengq> <20170329> modify for ID 98255 begin
    private static String TAG = "BluetoothTest";
    //Gionee <GN_BSP_MMI> <chengq> <20170329> modify for ID 98255 end
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DswLog.d(TAG, "\n\n\n****************打开蓝牙 @" + Integer.toHexString(hashCode()));
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case BEGIN_TO_SCAN:
                        ...
                        mIsDiscovery = true;
                        break;
                    //Gionee <GN_BSP_MMI> <chengq> <20170328> modify for ID 94093 begin
                    case BlUE_UPDATE_UI:
                        DswLog.e(TAG, "BlUE_UPDATE_UI mUiHandler.getMessage");
                        BluetoothDevice device = (BluetoothDevice)msg.obj;
                        if (devicesListCheck(device)) {
                            return;
                        }
                        ...
                        break;
                        //Gionee <GN_BSP_MMI> <chengq> <20170328> modify for ID 94093 end
                }
            }
        };
    ...
    protected void onDestroy() {
        super.onDestroy();
        DswLog.d(TAG, "\n****************退出蓝牙 @" + Integer.toHexString(hashCode()));
    }
    ...
    protected void onStart() {
        ...
        mReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                DswLog.e(TAG, "intent " + intent.toString());
                ...
                if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                    ...
                    msg.obj = device;
                    msg.what = BlUE_UPDATE_UI;
                    mUiHandler.sendMessage(msg);
                    DswLog.e(TAG, " mUiHandler.sendMessage");
                    //Gionee <GN_BSP_MMI> <chengq> <20170328> modify for ID 94093 begin
                }
            }
        };
...
//                }
    ...
    private boolean devicesListCheck(BluetoothDevice device) {
        for (BluetoothDevice dev : mDevices) {
            if (dev.equals(device)) {
                DswLog.i(TAG, "buletooth has same devices address="+dev.getAddress());
                return true;
            }
        }
        return false;
    ...
    private void releaseBluetooth() {
        ...
        DswLog.i("aaaa", "releaseBluetooth");
        exceptionHd.removeMessages(TRY_AGAIN);
            ...
            switch (msg.what) {
                case TRY_AGAIN:
                    if (mArrayAdapter.isEmpty()) {
                        DswLog.e(TAG, "mArrayAdapter.isEmpty(), so disable BT then open and discover again");
    ...
    BroadcastReceiver btRec = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            DswLog.d(TAG, BluetoothAdapter.ACTION_STATE_CHANGED + ":" + state);
