...
import gn.com.android.mmitest.item.DevicesInfo;
...
public class GnMMITest extends BaseActivity implements OnItemClickListener {
    ...
    BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(NV_BACKUP_END)) {
                DswLog.e(TAG, "send android.intent.action.MASTER_CLEAR");
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		GnMMITestApplication.rotation = Settings.System.getInt(getContentResolver(),Settings.System.ACCELEROMETER_ROTATION, 0);
		Settings.System.putInt(getContentResolver(),Settings.System.ACCELEROMETER_ROTATION,0);
		DswLog.d(TAG,"start and save GnMMITestApplication.rotation is "+ GnMMITestApplication.rotation);
        ...
        if ( SystemProperties.get("ro.gn.stereo.support").equals("yes")) {
            GnMMITestApplication.stereoEnable = SystemProperties.get("persist.sys.gn.stereo.enable");
        ...
        //Chenyee <CY_BSP_MMI> <chengq> <20170911> add for CR 199791 begin
        GnMMITestApplication.mmi_navi_bar = Settings.Global.getInt(getContentResolver(),"navigation_bar_color", 0);
        Settings.Global.putInt(getContentResolver(),"navigation_bar_color", 1);
        DswLog.d(TAG,"set mmi_navi_bar= " + Settings.Global.getInt(getContentResolver(),"navigation_bar_color", 0));
        //Chenyee <CY_BSP_MMI> <chengq> <20170911> add for CR 199791 end
    ...
    public void onResume() {
        ...
        DswLog.e(TAG, " GnMMITest onResume");
        DswLog.e(TAG, " persist.radio.dispatchAllKey = " + SystemProperties.get("persist.radio.dispatchAllKey", "false"));
    }

    @Override
    public void onPause() {
        super.onPause();
        DswLog.e(TAG, " GnMMITest onPause11");
    ...
    public void onStop() {
        super.onStop();
        DswLog.e(TAG, " GnMMITest onStop");
    }

    @Override
    protected void onStart() {
        super.onStart();
        DswLog.e(TAG, " GnMMITest onStart");
    }
    @Override
            ...
            case EFUSE_WRITE_DLG:
                builder.setMessage(R.string.efuse_need_write).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(level >= 25 && mSnByteArray[MMI_ALL_TAG] == MMI_PASS){
        ...
        switch (resultCode) { //resultCode为回传的标记，我在B中回传的是RESULT_OK
            case 1:
                    ...
                    mFactoryResetTask.execute();
                        ...
                        Toast.makeText(GnMMITest.this, getString(R.string.efuse_write_faild),Toast.LENGTH_SHORT).show();
                    }
                    break;
                case 2:
        ...
        switch (position) {
            ...
            case 3: {
                /*if (!FeatureOption.GN_RW_GN_MMI_EFUSE_SUPPORT) {
                    ...
                    mSnByteArray = ProinfoUtil.getProductInfo();
    ...
    private void releaseMmi(boolean exit) {
        ...
        //Gionee <GN_BSP_MMI> <chengq> <20170321> modify for ID 89433 begin
        if ( SystemProperties.get("ro.gn.stereo.support").equals("yes")) {
            SystemProperties.set("persist.sys.gn.stereo.enable", GnMMITestApplication.stereoEnable);
            DswLog.d(TAG,"exit mmi persist.sys.gn.stereo.enable="+SystemProperties.get("persist.sys.gn.stereo.enable"));
        }
        //Gionee <GN_BSP_MMI> <chengq> <20170321> modify for ID 89433 end
	    Settings.System.putInt(getContentResolver(),Settings.System.ACCELEROMETER_ROTATION,GnMMITestApplication.rotation);
		DswLog.d(TAG,"exit and set GnMMITestApplication.rotation is "+ GnMMITestApplication.rotation);
		//Gionee <GN_BSP_MMI> <chengq> <20170224> add for ID 49681 end
        //Gionee <GN_BSP_MMI> <chengq> <20170216> modify for ID 70046 end
        SystemProperties.set("persist.radio.dispatchAllKey", "false");
        DswLog.e(TAG, "releaseMmi: persist.radio.dispatchAllKey = " + SystemProperties.get("persist.radio.dispatchAllKey", "false"));
        ...
        //Chenyee <CY_BSP_MMI> <chengq> <20170911> add for CR 199791 begin
        Settings.Global.putInt(getContentResolver(),"navigation_bar_color", GnMMITestApplication.mmi_navi_bar);
        DswLog.d(TAG,"revert set mmi_navi_bar= " + Settings.Global.getInt(getContentResolver(),"navigation_bar_color", 0));
        //Chenyee <CY_BSP_MMI> <chengq> <20170911> add for CR 199791 end
