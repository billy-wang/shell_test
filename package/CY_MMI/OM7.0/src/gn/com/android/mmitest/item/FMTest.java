...
public class FMTest extends BaseActivity implements SeekBar.OnSeekBarChangeListener,
    ...
    private class RemoteServiceConnection implements ServiceConnection {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            if (null == mService) {
                ...
                DswLog.i(TAG, "onServiceConnected start powerup thread");
                new Thread() {
                    public void run() {
                        try {
                            /*Gionee huangjianqiang 20160616 add for CR01715226 begin*/
                            ...
                            /*Gionee huangjianqiang 20160624 add for CR01722202 begin*/
                            if (mService.isDeviceOpen() || mService.openDevice()) {
                                if (mService.isPowerUp() ||  mService.powerUp(defaultFrequency)) {
                            ...
                            /*Gionee huangjianqiang 20160616 add for CR01715226 end*/
                                                enableWidget(true);
                                                DswLog.e(TAG, "fm power up success");
                                            } catch (Exception e) {
                                                DswLog.e(TAG, "mService.tune:Exception=" + e.getMessage());
                                            }
                                        }
                                    });
                                } else {
                            ...
                            DswLog.e(TAG, "mService:Exception=" + e.getMessage());
                        }
                    }
                }.start();
    ...
    public void onStart() {
        ...
        super.onStart();
        DswLog.e(TAG, "stUtils.IS_BLU ="+TestUtils.IS_BLU);
        if(TestUtils.IS_BLU) {
        ...
        if (null != mAM) {
            ...
            DswLog.e(TAG, "maxVol = " + maxVol + " setStreamVolume = " + (maxVol - 4));
        }
        if (mEarphonePluginReceiver != null) {
            try {
                ...
                DswLog.e(TAG, "registerReceiver:error=" + e.getMessage());
            }
        }
        ...
        if (false == mIsBind) {
            ...
            DswLog.e(TAG, "onStart bindService : " + mIsBind);
            if (true == mIsBind) {
                //enableWidget(true);
            } else {
    ...
    private void stopFm() {
        ...
        if (null != mEarphonePluginReceiver) {
            ...
            try {
                ...
                DswLog.e(TAG, "unregisterReceiver error=" + e.getMessage());
            }
        ...
        if (true == mIsBind) {
            try {
                ...
                DswLog.e(TAG, "unbindService:error=" + e.getMessage());
            }
        }
        try {
            if(TestUtils.IS_BLU) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.default_btn: {
                ...
                //Gionee <GN_BSP_MMI> <chengq> <20170225> modify for ID 68259 begin
				frequency = defaultFrequency;
                //Gionee <GN_BSP_MMI> <chengq> <20170225> modify for ID 68259 end
                if (false == mIsBind) {
                    return;
                }
                try {
    ...
    private BroadcastReceiver mEarphonePluginReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(Intent.ACTION_HEADSET_PLUG)) {
                ...
                DswLog.i(TAG, "onReceive:state=" + state);
...
//                        mIsPlud = true;
    ...
    void turnOnFM() {
		...
		DswLog.i(TAG,"frequency is "+ frequency);
        if (true == mIsBind) {
            DswLog.e(TAG, "bindService success");
            enableWidget(true);
        } else {
            DswLog.e(TAG, "bindService fail");
        }
                ...
                new Thread() {
                    public void run() {
                        try {
                            ...
                            if (mBLUService.isDeviceOpen() ||mService.openDevice()) {
                                if (mBLUService.isPowerUp() || mService.powerUp(defaultFrequency)) {
                                    mHandler.post(new Runnable() {
                                        public void run() {
                                            try {
                                                mBLUService.tuneStationAsync(defaultFrequency);
