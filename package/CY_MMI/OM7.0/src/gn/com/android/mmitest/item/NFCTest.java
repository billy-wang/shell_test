...
public class NFCTest extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DswLog.d(TAG, "\n\n\n****************打开NFC @" + Integer.toHexString(hashCode()));
        ...
        if (!mNfcAdapter.isEnabled()) {
            DswLog.i(TAG, "mNfcAdapter != isEnable");
            mNfcAdapter.enable();
        } else {
            DswLog.i(TAG, "mNfcAdapter = isEnable");
        }
    ...
    protected void onDestroy() {
        super.onDestroy();
        DswLog.d(TAG, "\n****************退出NFC @" + Integer.toHexString(hashCode()));
    }
    ...
    public void onNewIntent(Intent intent) {
        DswLog.i(TAG, "intent.getAction()=" + intent.getAction());
