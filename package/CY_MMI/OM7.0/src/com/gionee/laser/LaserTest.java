...
public class LaserTest extends BaseActivity implements OnClickListener {
    ...
    private void refreshStatus() {
        ...
        showResult();
        DswLog.i(TAG, "refreshStatus:mIsOffsetCaled=" + mIsOffsetCaled + ";mIsCrosstalkCaled=" + mIsCrosstalkCaled
    ...
    private void execCmd(int cmd) {
        if (cmd == LASER_OFFSET_ID) {
            ...
            DswLog.i(TAG, "execCmd LASER_OFFSET_ID:laserOffsetCalStart = " + laserOffsetCalStart + ";mIsOffsetCaled=" + mIsOffsetCaled + ";mOffsetValue=" + mOffsetValue);
            ...
            DswLog.i(TAG, "execCmd LASER_CROSSTALK_ID:laserCrosstalkCalStart = " + laserCrosstalkCalStart + ";mIsCrosstalkCaled="
            ...
            DswLog.i(TAG, "execCmd LASER_DISTANCE_ID:mIsOffsetCaled = " + mIsOffsetCaled + ";mIsCrosstalkCaled=" + mIsCrosstalkCaled
    ...
    private void showResult() {
        DswLog.i(TAG, "showResult" + ";mDistance=" + mDistance + ";mIsTestSuccess=" + mIsTestSuccess + ";mIsOffsetCaled=" + mIsOffsetCaled
