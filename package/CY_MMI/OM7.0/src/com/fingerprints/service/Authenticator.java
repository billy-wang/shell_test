        ...
        public void onIsUserIDValidResult(final boolean isUserIDValid) throws RemoteException {
            synchronized (mIdValidLock) {
                if (mIdValid == IdValid.UNDEFINED) {
                    DswLog.e(TAG, "Unexpected user ID Valid result: " + String.valueOf(isUserIDValid)
                            + ". Ignoring.");
                } else {
    ...
    public boolean isUserIDValid(byte[] userID) {
        ...
        synchronized (mIdValidLock) {
            if (mIdValid == IdValid.VALUE_REQUESTED) {
                DswLog.e(TAG, "isUserIDValid called multiple times. Throwing RuntimeException.");
            ...
            try {
                ...
                DswLog.e(TAG, "No response from FPC Extension service. Throwing RuntimeException.");
            ...
            if (mIdValid == IdValid.VALUE_REQUESTED || mIdValid == IdValid.UNDEFINED) {
                DswLog.e(TAG, "No callback received from isUserIDValid. Throwing RuntimeException.");
