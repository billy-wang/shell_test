...
public class DevicesInfo extends BaseActivity implements OnClickListener {
    ...
    private static String FILE_NAME_GTL = "/sys/devices/platform/cy_device_check/name";
    ...
    private void showGtlType() {
        ...
        String gtlType = null;
        String lcdType = null, GType = null, TPType = null, cameraType = null, LPType = null, MPType = null;
        String main_cam = null, main2_cam = null, sub_cam = null, sub2_cam = null;
        String fingerType = null;
        String memType = null;
        String batteryType = null;
        String wireless_chargeType = null;
        ...
        try {
            if (isFileExists) {
                ...
                while ((data = br.readLine()) != null) {
                    ...
                    } else if (data.contains("M-sensor")) {
                        MPType = str[str.length - 1];
                    ...
                    } else if (data.contains("CHG")) {
                        wireless_chargeType = str[str.length - 1];
                    }
                }
            } else {
        ...
        if (isFileExists) {
            ...
            if (!TextUtils.isEmpty(MPType)) {
                gtlType += ("\nM-sensor" + gnType + MPType);
            }
            ...
            if (!TextUtils.isEmpty(wireless_chargeType)) {
                gtlType += ("\nWireLessType:" + wireless_chargeType);
            }
