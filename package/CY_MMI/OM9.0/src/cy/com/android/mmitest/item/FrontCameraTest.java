...
public class FrontCameraTest extends BaseActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        DswLog.d(TAG, "\n\n\n****************打开前摄像头 @" + Integer.toHexString(hashCode()));
        ...
        String ver = SystemProperties.get("ro.cy.rom.vernumber");
        Intent localIntent;
        localIntent = new Intent("cy.com.android.mmitest.item.FrontCameraTest");
        DswLog.e(TAG, "FrontCameraTest sendintent cy.com.android.mmitest.item.FrontCameraTest");
        ...
        DswLog.e(TAG, "FrontCameraTest  startActivityForResult");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        DswLog.d(TAG, "\n****************退出前摄像头 @" + Integer.toHexString(hashCode()));
    }

    @Override
    public void onResume() {
        super.onResume();
        DswLog.e(TAG, "FrontCameraTest onResume ");
    ...
    public void onPause() {
        super.onPause();
        DswLog.e(TAG, "FrontCameraTest onPause ");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        DswLog.e(TAG, "FrontCameraTest onActivityResult" + "requestCode = " + requestCode + " resultCode = " + resultCode);
        mFrontCamera = false;
