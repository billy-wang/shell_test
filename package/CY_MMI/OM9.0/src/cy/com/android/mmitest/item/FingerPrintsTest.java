...
public class FingerPrintsTest extends BaseActivity implements OnClickListener ,OnPerformListen{
    ...
    private static final int MESSAGE_FAIL_MOVE_FAST = 5;
            ...
            switch (msg.what) {
                case MESSAGE_SUCCESS:
                    ...
                    if (TestUtils.mIsAutoMode) {
                        HelPerformUtil.getInstance().performDelayed(FingerPrintsTest.this, 600);
                    }
                    break;
                case MESSAGE_FAIL_MOVE_FAST:
    ...
    private void startTest() {
        ...
        //fingerprintmanager.test(cancellationSignal,4);
        try {
            if(null != testMethod){
                testMethod.invoke(fingerprintmanager, new Object[] {cancellationSignal,4});
            }
