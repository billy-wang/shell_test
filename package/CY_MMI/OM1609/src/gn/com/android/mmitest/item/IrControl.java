...
public class IrControl {
    ...
    public IrControl(Context ctx){
        ...
        if(objir == null) Log.d("RemoteIr", "No RemoteIR");
        if(method_transmit == null) Log.d("RemoteIr", "No Transmit Method");
        if(method_stop == null) Log.d("RemoteIr", "No Stop Method");
         if(method_receive == null) Log.d("RemoteIr", "No received Method");
        if(method_receive_init == null) Log.d("RemoteIr", "No receive_init Method");
         if(method_receive_is_ready == null) Log.d("RemoteIr", "receive_is_ready");
        //if(method_stop == null) Log.d("RemoteIr", "No Stop Method");
    }
    ...
    public int ReceivedIsRead()
    {
        ...
        {
            Log.e("RemoteIr recevied is read method", e.toString());
        }
    ...
    public int RecviedIR(byte[] buffer,int i32MaxLength)
    {
        ...
        {
            Log.e("RemoteIr reccevie method", e.toString());
        }
